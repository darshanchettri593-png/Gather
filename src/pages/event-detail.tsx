...
export function EventDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="relative min-h-screen pb-[100px]" style={{ backgroundColor: "#000000" }}>
  ...
  if (error || !event) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen px-4 text-center" style={{ backgroundColor: "#000000" }}>
  ...
  // ─── Page ────────────────────────────────────────────────────────────────────
  return (
    <div className="relative min-h-screen" style={{ backgroundColor: "#000000", paddingBottom: "180px" }}>
